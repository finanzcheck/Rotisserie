...
export const ResultScreen = ({ navigation }) => {
  ...
  let imageSource = "https://www.baseballprospectus.com/wp-content/uploads/2018/04/this-is-fine.jpg";
  const sizeRatio = { width: 310, height: 150, marginTop: 50 };

  if(average >= 2 && average <= 3) {
    imageSource = "https://www.meme-arsenal.com/memes/579fffcfd3780f6d8224226433f35d74.jpg";
    sizeRatio.height = 200;
  } else if(average > 3) {
    imageSource = "https://images.maennersache.de/success-kid,id=22d8f890,b=maennersache,w=1100,rm=sk.jpeg"
  }
  ...
  return (
    <View style={styles.top}>
      ...
      <View style={styles.centered}>
        <Text style={styles.titleText}>Your average is <Text style={{color: "red"}}>{average}</Text></Text>
        <Image
            style={sizeRatio}
